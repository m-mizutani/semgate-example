    ...
    <div>
      ...
      <div className="disclaimer" role="note">
        ...
        <ul>
          ...
          <li>Nothing is actually executed: no database, no shell, no filesystem, no outbound
            requests. Inputs are parsed and evaluated only to decide whether an attack would fire.</li>
